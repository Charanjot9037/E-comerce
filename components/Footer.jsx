    ...
    const linkSections = [
        {
            ...
            links: [
                ...
                { text: "Suits", path: '/', icon: null },
                { text: "T-Shirts", path: '/', icon: null },
                ...
                <div className="flex flex-col md:flex-row items-start justify-between gap-10 py-10 border-b border-slate-500/30 text-slate-500">
                    <div>
                        <Link href="/" className="text-4xl font-semibold text-slate-700">
                            <span className="text-green-600">Urban</span>clothing<span className="text-green-600 text-5xl leading-0">.</span>
                        </Link>
                       <p className="max-w-[410px] mt-6 text-sm">
  Welcome to Urban clothing, your ultimate destination for trendy and quality clothing. From casual wear and workwear to must-have accessories, we bring you the latest styles — all in one place.
</p>
